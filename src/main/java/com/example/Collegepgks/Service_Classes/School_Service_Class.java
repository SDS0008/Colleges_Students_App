...
@Service
public class School_Service_Class implements All_Coll_Design  {
...
String Sql = "insert into school values(?,?,?,?,?)";
	...
	public Data_pack Update(Data_pack data_pack) {
		...
		String Sql3 = "update school set Fullname=?,Emailid=?,District=?,contact=? where  Rollno=?";
	...
	public Data_pack Delete(String Rollno) {
		...
		String Sql4 = "delete from school where Rollno=? ";
