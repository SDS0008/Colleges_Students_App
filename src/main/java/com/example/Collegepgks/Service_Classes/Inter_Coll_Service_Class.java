...
@Service
public class Inter_Coll_Service_Class implements All_Coll_Design {
...
String Sql = "insert into inter values(?,?,?,?,?)";
	...
	public Data_pack Update(Data_pack data_pack) {
		...
		String Sql3 = "update inter set Fullname=?,Emailid=?,District=?,contact=? where  Rollno=?";
	...
	public Data_pack Delete(String Rollno) {
		...
		String Sql4 = "delete from inter where Rollno=? ";
